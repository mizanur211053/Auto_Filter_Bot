...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code> v1.4 [ Sᴛᴀʙʟᴇ ]</code>
    ...
    CHANNELS = "https://t.me/Movixuniverse"
...
<blockquote>আপনি শুধু আমাদের গ্রোপে মুভি রিকুয়েষ্ট করতে পারবেন। আপনি সরাসরি বটে মুভি সাট্চ করতে পারবেন না। তো নিচের বাটনে ক্লিক করে গ্রোপে জয়েন হয়ে রিকুয়েষ্ট করুন</blockquote></b>"""
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @Movixuniverse_group
...
<blockquote>ᴀᴀᴘᴋᴀ <b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss</b> সরিয়ে দেয়া হয়েছে।  
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://github.com>Movixuniverse</a>\n """
