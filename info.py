...
# ============================
SESSION = environ.get('SESSION', 'Movixuniverse_search')   # Session name for the bot
...
PICS_URL = (environ.get('PICS', 'https://i.postimg.cc/bvrvG7dx/IMG-20260603-064425-017.jpg')).split()
PICS = (environ.get('PICS', 'https://i.postimg.cc/bvrvG7dx/IMG-20260603-064425-017.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://i.postimg.cc/bvrvG7dx/IMG-20260603-064425-017.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7055900476').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003757834181').split()]  # Channel id for auto indexing (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1004493171050')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movixuniverse_group')  # Support group link (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/Mizanur_Rahman41')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '01909443351')    # Owner UPI ID for payments
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Movixuniverse")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Movixuniverse")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Movixuniverse")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "69f7e49b83af44a6c10c2e2a6f2ede93b1f79ef9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "nanolinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "69f7e49b83af44a6c10c2e2a6f2ede93b1f79ef9")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nanolinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "69f7e49b83af44a6c10c2e2a6f2ede93b1f79ef9")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movixuniverse_search_group') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Mizanur_Rahman41') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Movixuniverse') # Update channel link for the bot
...
PORT = int(environ.get("PORT", "7860"))  # Port for the web server (default: 8080)
...
FQDN = str(getenv('FQDN', 'mizanur211053-movixuniverse-search-bot.hf.space'))
URL = "https://{}/".format(FQDN) if ON_HEROKU or NO_PORT else "https://{}/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'Movixuniverse'))
MULTI_CLIENT = False
name = str(environ.get('name', 'MOVIXUNIVERSE'))
